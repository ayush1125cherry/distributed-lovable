    ...
    public class GlobalExceptionHandler {
        ...
        public ResponseEntity<ApiError> handleInputValidation(MethodArgumentNotValidException ex){
            ...
            ApiError apiError = new ApiError(HttpStatus.BAD_REQUEST,"Input ValidationField",errors);
            log.error(apiError.toString(),ex);
            return  ResponseEntity.status(apiError.status()).body(apiError);
        }
        ...
        public ResponseEntity<ApiError> handleUserNotFoundException(UsernameNotFoundException ex) {
            ...
            ApiError apiError = new ApiError(HttpStatus.NOT_FOUND,"User name not found with user name "+ ex.getMessage());
